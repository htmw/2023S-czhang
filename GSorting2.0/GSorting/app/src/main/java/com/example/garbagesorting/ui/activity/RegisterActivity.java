        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(imagePath)) {//请上传头像
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_avatar_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(account)) {//用户名不能为空
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_account_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(nickName)) {//昵称不能为空
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_nickname_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(phone)) {//手机号不能为空
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_mobile_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(address)) {//地址不能为空
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_address_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(password)) {//密码为空
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_password_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if (!password.equals(passwordSure)) {//密码不一致
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_differ), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (mUser == null) {//用户不存在 注册
                    ...
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_successful), Toast.LENGTH_SHORT).show();
                    finish();
                } else {//用户存在
                    Toast.makeText(RegisterActivity.this, getText(R.string.text_register_exists), Toast.LENGTH_SHORT).show();
                }
                db.close();
            }
        });
