        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("".equals(account)){//用户名不能为空
                    Toast.makeText(LoginActivity.this,getText(R.string.text_login_account_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                if ("".equals(password)){//密码为空
                    Toast.makeText(LoginActivity.this,getText(R.string.text_login_password_hint), Toast.LENGTH_LONG).show();
                    return;
                }
                User mUser = null;
                //通过账号查询用户是否存在
                ...
                if (mUser != null) {//用户存在
                    if (!password.equals(mUser.getPassword())) {//判断密码是否正确
                        Toast.makeText(LoginActivity.this, getText(R.string.text_login_wrong), Toast.LENGTH_SHORT).show();
                    }else{//密码验证成功
                    ...
                    Toast.makeText(LoginActivity.this, getText(R.string.text_login_nonexistence), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
